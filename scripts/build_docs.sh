...
usage() {
  echo "Usage: $0 [-b]"
  echo ""
  echo "Build Pytext documentation."
  echo ""
...
echo "-----------------------------------"
echo "Building PyText Docusaurus site"
echo "-----------------------------------"
cd website || exit
yarn
...
cwd=$(pwd)
python scripts/parse_sphinx.py -i "${cwd}/pytext/docs/build/html/" -o "${cwd}/website/pages/api/"
